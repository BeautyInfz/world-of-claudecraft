...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.nameplate.npcRole.auctioneer': '拍賣師',
  'hudChrome.nameplate.npcRole.banker': '銀行職員',
  'hudChrome.nameplate.npcRole.riftForgemaster': '裂隙鍛造大師',
  'hudChrome.nameplate.npcRole.cardMaster': '牌局大師',
  'hudChrome.nameplate.npcRole.crucibleQuartermaster': '熔爐軍需官',
  'hudChrome.nameplate.npcRole.heroicQuartermaster': '英雄軍需官',
  'hudChrome.nameplate.npcRole.pvpVendor': 'PvP商人',
  'hudChrome.nameplate.npcRole.weaponsmithTrainer': '鍛造訓練師',
  'hudChrome.nameplate.npcRole.cookingTrainer': '烹飪訓練師',
  'hudChrome.nameplate.npcRole.tailoringTrainer': '裁縫訓練師',
  'hudChrome.nameplate.npcRole.engineeringTrainer': '工程學訓練師',
  'hudChrome.nameplate.npcRole.leatherworkingTrainer': '製皮訓練師',
  'hudChrome.nameplate.npcRole.alchemyTrainer': '煉金術訓練師',
  ...
  'hudChrome.readyCheck.title': '就緒確認',
  'hudChrome.readyCheck.close': '關閉',
  'hudChrome.readyCheck.status': '已就緒：{ready}/{total}',
  'hudChrome.readyCheck.waiting': '等待回應...',
  'hudChrome.readyCheck.memberReady': '{name} 已準備就緒。',
  'hudChrome.readyCheck.memberNotReady': '{name} 尚未準備好。',
  'hudChrome.readyCheck.memberPending': '{name} 尚未回應。',
  'hudChrome.pullTimer.cancel': '開怪倒數已取消。',
  'hud.chat.templates.raidWarning': '[團隊警告] {name}：{message}',
  ...
  'hudChrome.social.who.searchPlaceholder': '名字、區域或公會',
  'hudChrome.social.who.search': '搜尋',
  'hudChrome.social.who.loading': '正在向伺服器查詢線上玩家...',
  'hudChrome.social.who.empty': '沒有符合的玩家。',
  'hudChrome.social.who.count': '{total} 人線上',
  'hudChrome.social.who.countFiltered': '{shown} / {total} 人線上',
  'hudChrome.social.who.capped': '僅顯示前 {delivered} 位。縮小搜尋範圍以查看其餘玩家。',
  'hudChrome.social.who.classFilter': '依職業篩選',
  'hudChrome.social.who.allClasses': '所有職業',
  'hudChrome.social.who.colStatus': '狀態',
  'hudChrome.social.who.colLevel': '等級',
  'hudChrome.social.who.colClass': '職業',
  'hudChrome.social.who.colGuild': '公會',
  'hudChrome.social.who.sortTitle': '依{column}排序',
  ...
  'itemUi.market.sweep': '掃貨',
  'itemUi.market.sweepAria': '在市場掃貨購買{item}',
  'itemUi.market.sweepTitle': '市場掃貨：{item}',
  'itemUi.market.sweepClose': '關閉',
  'itemUi.market.sweepNote':
    '依單價由低到高整批買下其他賣家的上架，直到湊足你要的數量。你可能會比要求的多收到幾件。',
  'itemUi.market.sweepQuantity': '需要數量',
  'itemUi.market.sweepQuoteNone': '沒有可掃貨的該物品上架。',
  'itemUi.market.sweepQuoteLine': '{listings}筆上架共{units}件，合計{total}（每件{each}）',
  'itemUi.market.sweepQuoteShort': '僅有{listings}筆上架共{units}件可購，合計{total}（每件{each}）',
  'itemUi.market.sweepButton': '掃貨',
  'itemUi.market.sweepConfirmTitle': '確認市場掃貨',
  'itemUi.market.sweepConfirmBody':
    '以{total}（每件{each}）從{listings}筆上架購買{item} x{units}？',
  'itemUi.market.sweepChanged': '掃貨報價在你確認前已變更。請核對總價後再試一次。',
  'itemUi.errors.sweepNoListings': '沒有可掃貨的該物品上架。',
  'itemUi.errors.sweepPriceChanged': '掃貨送達前價格已變更。請核對報價後再試一次。',
  ...
  'hudChrome.leaderboard.prestigeTitle': '威望 {rank}',
  ...
  'guide.controls.hideInterface': '隱藏介面（用於截圖和錄影）',
  ...
  'hudChrome.raidBossGuide.nythraxis.phaseKingsWrathSummary':
    '生命值降至{health}時，尼思拉克西斯咆哮著進入國王之怒，此後在普通難度獲得{bonusNormal}傷害，英雄難度則為{bonusHeroic}，直到戰鬥結束。墓穴爆發的間隔縮短至每{eruptionEveryNormal}秒一次（英雄難度{eruptionEveryHeroic}秒）。其餘機制節奏不變。',
  ...
  'hudChrome.raidBossGuide.nythraxis.boneSpikeSummary':
    '每{everyNormal}秒，尼思拉克西斯會將{victimsNormal}名非目前目標的團員穿刺在骨刺上。被穿刺的團員無法行動，並且每秒流失相當於最大生命值{drainNormal}的生命，直到該尖刺被摧毀。任何人命中骨刺{hitsNormal}次即可將其擊碎，無論傷害多寡。已被穿刺過的團員在{cooldown}秒內不會再次被選中，因此骨刺會分散到整個團隊。',
  'hudChrome.raidBossGuide.nythraxis.boneSpikeHeroicSummary':
    '每{everyHeroic}秒，尼思拉克西斯會將{victimsHeroic}名非目前目標的團員穿刺在骨刺上。被穿刺的團員無法行動，並且每秒流失相當於最大生命值{drainHeroic}的生命，直到該尖刺被摧毀。任何人命中骨刺{hitsHeroic}次即可將其擊碎，無論傷害多寡。已被穿刺過的團員在{cooldown}秒內不會再次被選中，因此骨刺會分散到整個團隊。',
  ...
  'hudChrome.raidBossGuide.nythraxis.kingsWrathSummary':
    '尼思拉克西斯此後在普通難度造成{bonusNormal}更多傷害，英雄難度則為{bonusHeroic}，直到戰鬥結束。墓穴爆發每{eruptionEveryNormal}秒發生一次（英雄難度{eruptionEveryHeroic}秒）。',
  ...
  'hudChrome.gathering.toolTooltip.wieldDegrade': '技能不足時，它仍可當作較低階的工具使用。',
  ...
  'hudChrome.keybinds.targetSelf': '選取自己',
  'hudChrome.keybinds.targetParty1': '選取隊友1',
  'hudChrome.keybinds.targetParty2': '選取隊友2',
  'hudChrome.keybinds.targetParty3': '選取隊友3',
  'hudChrome.keybinds.targetParty4': '選取隊友4',
  'hudChrome.keybinds.targetParty5': '選取隊友5',
  'hudChrome.keybinds.targetParty6': '選取隊友6',
  'hudChrome.keybinds.targetParty7': '選取隊友7',
  'hudChrome.keybinds.targetParty8': '選取隊友8',
  'hudChrome.keybinds.targetParty9': '選取隊友9',
  ...
  'hudChrome.finder.lockoutWeekly': '每個首領每週鎖定',
  ...
  'hudChrome.finder.mech.soul_rend': '靈魂撕裂（被標記者集合以分攤傷害）',
  ...
  'hudChrome.finder.mech.bloodmane_rend': '血鬃撕裂（流血，注意目標切換）',
  'hudChrome.finder.mech.tusk_sweep': '獠牙橫掃（正面順劈）',
  'hudChrome.finder.mech.ancestral_sap': '祖靈汁液（治療其盟友）',
  'hudChrome.finder.mech.call_of_the_hunt': '狩獵召喚（加速附近盟友）',
  'hudChrome.finder.mech.thickhide_ward': '厚皮護盾（護盾附近盟友）',
  'hudChrome.finder.mech.beast_pit_quake': '獸坑震擊（範圍傷害）',
  'hudChrome.finder.mech.wildheart_pulse': '狂野之心脈衝（週期性範圍傷害）',
  'hudChrome.finder.mech.jaguar_roar': '美洲豹咆哮（擊退）',
  'hudChrome.finder.mech.brand_of_the_pyre': '柴堆烙印（疊加的火焰標記，在導水管的水中洗淨）',
  'hudChrome.finder.mech.forge_strike': '熔爐打擊（疊加的坦克換位減益）',
  'hudChrome.finder.mech.rain_of_cinders': '餘燼之雨（三道火焰錐形，站在其間）',
  'hudChrome.finder.mech.falling_cinders': '墜落餘燼（玩家腳下的隕石圈，移出）',
  'hudChrome.finder.mech.revolving_inferno': '迴旋煉獄（旋轉的火焰射線，穿過缺口）',
  'hudChrome.finder.mech.forge_wave': '熔爐之波（擴散的火牆，利用兩條安全通道）',
  'hudChrome.finder.mech.apocalypse_add': '伊格尼瓦的喚灰者（施放天啟的優先目標，速殺）',
  'hudChrome.finder.mech.judgment_of_the_forge': '熔爐審判（過渡階段，共享唯一的安全庇護）',
  'hudChrome.finder.mech.last_inferno': '最後煉獄（生命值20%時的45秒狂暴）',
  'hudChrome.finder.mech.chains_of_the_forge': '熔爐鎖鏈（僅英雄難度，緊靠被鏈接的同伴）',
  'hudChrome.finder.mech.makers_brand': '造物主烙印（疊加的坦克換位減益）',
  'hudChrome.finder.mech.forgefathers_sweep': '熔爐之父橫掃（對非坦克的寬正面錐形）',
  'hudChrome.finder.mech.tempering_ray': '淬火射線（射向被標記玩家的直線，上前攔截）',
  'hudChrome.finder.mech.cinder_orbs': '餘燼寶珠（被標記的玩家散開至房間邊緣）',
  'hudChrome.finder.mech.forgestorm': '熔爐風暴（墜落的隕石圈，移出）',
  'hudChrome.finder.mech.shared_pyre': '共享柴堆（集合圈，分攤傷害）',
  'hudChrome.finder.mech.anvils_decree': '鐵砧法令（三次全團鎚擊，用治療撐過）',
  'hudChrome.finder.mech.masters_assembly': '大師裝配（阻擋熔爐光束，輪換阻擋者）',
  ...
  'hudChrome.recipeTracker.collapseHint': '收合配方追蹤器',
  'hudChrome.recipeTracker.expandHint': '展開配方追蹤器',
  'hudChrome.recipeTracker.pin': '釘選',
  'hudChrome.recipeTracker.unpin': '取消釘選',
  'hudChrome.recipeTracker.pinFull': '配方追蹤器已滿（最多 {cap} 個配方）',
  'hudChrome.recipeTracker.pinAria': '將{name}釘選到HUD追蹤器',
  'hudChrome.recipeTracker.unpinAria': '從HUD追蹤器取消釘選{name}',
  ...
  'guide.profPages.farm.rhythmBody':
    '播種是瞬間完成的，因為鋤頭開放的是新的地形，而不是買來速度：沒有需要等待的施法，所以轉身離開的農夫也一樣已經種下了。拔起成熟的作物同樣是瞬間完成，沒有施法可打斷，也沒有背包檢查會攔下它；已經成熟的田畦你放多久它就等多久，所以行囊裝滿對農夫來說，代價不過是走一趟去清空而已。\n\n一次收成付的是農產品與耕作熟練。與礦脈不同，它完全不給角色經驗，因此田畦是一門用來經營的手藝，而不是升級的途徑。',
  ...
  'hudChrome.auraOverlay.readyGlow': '快捷列高亮',
  'hudChrome.auraOverlay.readyGlowHint': '當該法術的增益生效時，在動作列上高亮顯示它。',
  'hudChrome.auraOverlay.reticleTick': '準星刻度',
  'hudChrome.auraOverlay.reticleTickHint': '在螢幕中央附近加入一個標記，該法術觸發時會亮起。',
  'hudChrome.auraOverlay.haptic': '震動',
  'hudChrome.auraOverlay.hapticNone': '關閉',
  'hudChrome.auraOverlay.hapticHint': '震動已連接的手把或你的手機。裝置沒有震動功能時將被忽略。',
  ...
  'hudChrome.auraOverlay.watchlistUnwatch': '停止監視{spell}',
  'hudChrome.auraOverlay.watchlistCount': '已監視 {count} 個',
  'hudChrome.auraOverlay.sound': '提示音',
  'hudChrome.auraOverlay.soundNone': '無聲音',
  'hudChrome.auraOverlay.soundVolume': '音量',
  'hudChrome.auraOverlay.soundPreview': '試聽',
  'hudChrome.auraOverlay.soundPreviewAria': '試聽「{sound}」提示音',
  'hudChrome.auraOverlay.cues.softChime': '輕柔鈴聲',
  'hudChrome.auraOverlay.cues.musicBox': '八音盒',
  'hudChrome.auraOverlay.cues.glassPing': '玻璃脆響',
  'hudChrome.auraOverlay.cues.waterDrop': '水滴',
  'hudChrome.auraOverlay.cues.bubblePop': '氣泡破裂',
  'hudChrome.auraOverlay.cues.hardBell': '銅鐘',
  'hudChrome.auraOverlay.cues.templeGong': '寺鐘',
  'hudChrome.auraOverlay.cues.anvilStrike': '鐵砧敲擊',
  'hudChrome.auraOverlay.cues.coinDrop': '落幣',
  'hudChrome.auraOverlay.cues.swordDraw': '拔劍',
  'hudChrome.auraOverlay.cues.blaringHorn': '嘹亮號角',
  'hudChrome.auraOverlay.cues.carKlaxon': '汽車喇叭',
  'hudChrome.auraOverlay.cues.sonarPing': '聲納',
  'hudChrome.auraOverlay.cues.electricZap': '電擊',
  'hudChrome.auraOverlay.cues.catMeow': '貓叫',
  'hudChrome.auraOverlay.cues.owlHoot': '貓頭鷹叫',
  'hudChrome.auraOverlay.cues.wolfHowl': '狼嚎',
  'hudChrome.auraOverlay.cues.frogCroak': '蛙鳴',
  'hudChrome.auraOverlay.cues.windWhoosh': '風聲',
  'hudChrome.auraOverlay.cues.steamHiss': '蒸汽聲',
  ...
  'guide.controls.targetSelf': '選取你自己',
  'guide.controls.targetParty': '選取隊友1至9（依隊伍框架由上而下的顯示順序）',
  ...
  'hudChrome.professionTrainers.blacksmithing': '鍛造訓練師',
  'hudChrome.professionTrainers.cooking': '烹飪訓練師',
  'hudChrome.professionTrainers.tailoring': '裁縫訓練師',
  'hudChrome.professionTrainers.engineering': '工程學訓練師',
  'hudChrome.professionTrainers.leatherworking': '製皮訓練師',
  'hudChrome.professionTrainers.alchemy': '鍊金術訓練師',
  ...
  'hudChrome.wocStore.mountRideIt': '騎上試試',
  'hudChrome.wocStore.mountOnly': '僅坐騎',
  'hudChrome.wocStore.mountBuy': '購買坐騎造型',
  'hudChrome.wocStore.mountScopeLine': '帳號通用造型。同一時間只能由一名角色穿戴。',
  ...
  'hudChrome.cosmetics.preview': '預覽',
  'hudChrome.cosmetics.previewAria': '預覽{name}',
  ...
  'hudChrome.social.who.colZone': '區',
  'hudChrome.social.who.tab': '世界衛生組織',
  'hudChrome.wocMarket.colSaleType': '類型',
  'hudChrome.wocMarket.colSoldAt': '賣',
  'hudChrome.wocMarket.saleTypeBuyNow': '立即購買',
