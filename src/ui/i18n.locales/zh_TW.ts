...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.itemTooltip.durabilityLow': '耐久度過低：耐久度歸零時屬性加成將失效。',
  'hudChrome.walletPanel.title': 'WoC 錢包',
  'hudChrome.walletPanel.close': '關閉錢包面板',
  'hudChrome.walletPanel.connect': '連接錢包',
  'hudChrome.walletPanel.disconnect': '中斷錢包連接',
  'hudChrome.walletPanel.onChainBalance': '鏈上餘額：',
  'hudChrome.walletPanel.holdingGate': '領取需要至少 {amount} $WOC。',
  'hudChrome.walletPanel.offChainBalance': '遊戲內餘額：',
  'hudChrome.walletPanel.claimButton': '領取',
  'hudChrome.walletPanel.cooldownActive': '上次領取後需等待24小時才能再次領取。',
  'hudChrome.walletPanel.gateNote': '請在已連接的錢包中持有不低於上方所示的最低數量以進行領取。',
  'hudChrome.walletPanel.amountLabel': '領取數量',
  'hudChrome.walletPanel.feeGross': '數量：{amount} $WOC',
  'hudChrome.walletPanel.feeNet': '實際到帳：{amount} $WOC',
  'hudChrome.walletPanel.feeTreasury': '國庫手續費（10%）：{amount} $WOC',
  'hudChrome.walletPanel.feeBurn': '銷毀（10%）：{amount} $WOC',
  'hudChrome.walletPanel.confirmButton': '確認',
  'hudChrome.walletPanel.cancelButton': '取消',
  'hudChrome.walletPanel.claimPending': '領取中……',
  'hudChrome.walletPanel.claimSuccess': '領取完成。{amount} $WOC 已發送至您的錢包。',
  'hudChrome.walletPanel.reserveLabel': '領取錢包儲備：',
  'hudChrome.walletPanel.circulationChartTitle': '遊戲內流通量',
  'hudChrome.walletPanel.flowChartTitle': '鏈上流量',
  'realm.wocUnleashedTip':
    'WoC Unleashed：金幣即 $WOC，一種可提領至您錢包的真實Solana代幣，其餘玩法與Claudemoon完全相同。',
  'itemUi.vendor.repairAll': '全部修理（{count}）- {cost}',
  'mode.serverUnleashedOffline': 'WoC Unleashed（離線）',
  ...
  'hudChrome.itemTooltip.durabilityBroken': '已損壞。需要修理才能恢復該物品的加成效果。',
};
