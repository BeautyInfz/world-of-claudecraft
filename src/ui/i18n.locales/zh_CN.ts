...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.itemTooltip.durabilityLow': '耐久度过低：耐久度归零时属性加成将失效。',
  'hudChrome.walletPanel.title': 'WoC 钱包',
  'hudChrome.walletPanel.close': '关闭钱包面板',
  'hudChrome.walletPanel.connect': '连接钱包',
  'hudChrome.walletPanel.disconnect': '断开钱包连接',
  'hudChrome.walletPanel.onChainBalance': '链上余额：',
  'hudChrome.walletPanel.holdingGate': '领取需要至少 {amount} $WOC。',
  'hudChrome.walletPanel.offChainBalance': '游戏内余额：',
  'hudChrome.walletPanel.claimButton': '领取',
  'hudChrome.walletPanel.cooldownActive': '上次领取后需等待24小时才能再次领取。',
  'hudChrome.walletPanel.gateNote': '请在已连接的钱包中持有不低于上方所示的最低数量以进行领取。',
  'hudChrome.walletPanel.amountLabel': '领取数量',
  'hudChrome.walletPanel.feeGross': '数量：{amount} $WOC',
  'hudChrome.walletPanel.feeNet': '实际到账：{amount} $WOC',
  'hudChrome.walletPanel.feeTreasury': '国库手续费（10%）：{amount} $WOC',
  'hudChrome.walletPanel.feeBurn': '销毁（10%）：{amount} $WOC',
  'hudChrome.walletPanel.confirmButton': '确认',
  'hudChrome.walletPanel.cancelButton': '取消',
  'hudChrome.walletPanel.claimPending': '领取中……',
  'hudChrome.walletPanel.claimSuccess': '领取完成。{amount} $WOC 已发送至您的钱包。',
  'hudChrome.walletPanel.reserveLabel': '领取钱包储备：',
  'hudChrome.walletPanel.circulationChartTitle': '游戏内流通量',
  'hudChrome.walletPanel.flowChartTitle': '链上流量',
