...
export const ja_JP: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "tutorialGreeting": {
      ...
      "eastbrookArrivalNote": "イーストブルックへようこそ！レッドブルック元帥がすぐ目の前にいます。谷での仕事について彼に話しかけてみましょう。修練の浜へ戻りたいときは、町のレイヴンポストの郵便箱のそばにある渡しの鐘を鳴らしてください。",
  ...
  "guide": {
    ...
    "howToPlay": {
      ...
      "step2Body": "開始の街では、レッドブルック隊長が「戸口の狼」を持って待っており、近くのオデル親方にも仕事があります。どちらかに話しかけて、最初のクエストを受注しましょう。",
      "step3Title": "移動して見回す",
