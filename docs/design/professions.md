...
| MAIL_UNREAD_EXPIRY_SECONDS / MAIL_READ_EXPIRY_SECONDS | src/sim/mail/post_office.ts | 30 days / 3 days sim-time for a letter with nothing aboard; an unread Exchange Broker letter (WOC_MARKET_LETTER_IDS) has no clock until read |
